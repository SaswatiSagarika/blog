...
<head>
    ...
    <link href="<?php echo base_url(); ?>Vendor/css/bootstrap-table.css" rel="stylesheet">
    
    <link href="<?php echo base_url(); ?>Vendor/css/master.css" rel="stylesheet">
    <!-- Styles -->
    <link rel="stylesheet"
...
<body id="app-layout">
    ...
    <script src="<?php echo base_url(); ?>Vendor/js/jquery-2.2.4.js"></script>
    ...
    <script src="<?php echo base_url(); ?>Vendor/js/bootstrap-table.js"></script>
