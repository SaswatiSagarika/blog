            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                   ...
                   <p hidden><?php echo $record->getField('BlogId')?></p>
                        ...
                        <p><i> by </i> <?php echo $record->getField('AuthorName')?> <i> on
                        </i><?php echo $record->getField('Date')?></p>
                   ...
                   <div class="row">
                        ...
                        <div>
                            ...
                            <input type="hidden" class="form-control" name="id"
                                   id="id" value="<?php echo $record->getField('BlogId')?>">
                            ...
                            <br>                      
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <Textarea type="text" rows="8" class="form-control" name="comment"
                                                  id="comment"></textarea>
                                    </div>
                                </div>
